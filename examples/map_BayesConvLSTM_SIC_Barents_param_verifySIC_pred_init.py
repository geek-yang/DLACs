...
model_name = 'map_BayesConvLSTM_sic_ohc_Barents_hl_3_kernel_3_lr_0.01_epoch_700_validSIC.pkl'
################################################################################# 
#########                             main                               ########
#################################################################################
# set up logging files
logging.basicConfig(filename = os.path.join(output_path,'logFile_BayesConvLSTM_SIC_param_validSIC_pred_init.log'),
...
#                              0,0,0])
    ...
    for ens in range(ensemble):
        ...
        saveNC4 = dlacs.saveNetCDF.savenc(output_path, 'BayesConvLSTM_SIC_param_validSIC_pred_init_ens_{}.nc'.format(ens))
