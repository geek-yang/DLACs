...
logging.basicConfig(filename = os.path.join(output_path,'logFile_Lorenz84_train_ex_timescales.log'),
...
if __name__=="__main__":
    ...
    torch.save(model.state_dict(), os.path.join(output_path,'bayesconvlstm_lorenz84_ex_timescales.pkl'))
    ...
    plt.ylabel('Error')
    plt.legend()
    fig00.savefig(os.path.join(output_path,'BayesConvLSTM_pred_error_Lorenz84_ex_timescales.png'),dpi=150)
    ...
    plt.legend()
    plt.show()
    fig01.savefig(os.path.join(output_path,'BayesConvLSTM_pred_log_error_Lorenz84_ex_timescales.png'),dpi=150)
